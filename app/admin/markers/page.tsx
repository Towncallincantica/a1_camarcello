...
export default async function MarkersPage() {
  ...
  const { data: markers, error: markersError } = await supabase
    .from('map_markers')
    .select('marker_id, name, description, content_html, lat, lng, radius_meters, marker_type, interaction_type, interaction_data, icon, is_active, visibility_rules, sort_order, episode_id, custom_data')
